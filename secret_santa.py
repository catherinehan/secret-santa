...
class Person:
    def __init__(self, name, email, address, hobbies, invalid_matches):
        self.name = name
        self.email = email
...
def main(argv=None):
    ...
    try:
        ...
        for person in participants:
            ...
            name, email, hobbies, address = person.split("|")
            name = name.strip()
            invalid_matches = []
            ...
            person = Person(name, email, address, hobbies, invalid_matches)
